...
const BlogDetail = async ({ params }: Props) => {
  try {
    ...
    if (!blog || !blog.attributes) {
      return (
        <div className="flex flex-col min-h-screen w-full items-center justify-center">
          <Header backgroundColor="#FFF" />
          <div className="text-center">
            <h1 className="text-3xl font-bold mb-4">Invalid blog data</h1>
            <p className="text-gray-600">The blog data is corrupted.</p>
          </div>
          <Footer />
        </div>
      );
    ...
    const featuredBlogs = (featuredBlogsJSON ?? [])
      ...
      .map((blog: any) => ({
        slug: blog.attributes.slug || 'unknown',
        src:
        ...
        buttonLink: blog.attributes.slug || 'unknown',
      }));
        ...
        <div className="flex flex-col md:flex-row w-full items-center md:items-start mx-0 md:mx-auto px-2 lg:px-5 py-3 ">
          <div className="w-full flex flex-col  bg-white md:w-2/3 rounded-lg shadow-lg p-2 md:p-8 mx-2 md:mx-4 md:mr-8 mt-1 md:mt-[-15rem] z-10">
            ...
            <h1 className="text-3xl xl:text-4xl font-bold mb-4">
              {blog.attributes.title || 'Untitled'}
            </h1>
    ...
    return (
      <div className="flex flex-col min-h-screen w-full items-center justify-center">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Unable to load the blog at this time. Please try again later.
          </p>
        </div>
        <Footer />
      </div>
