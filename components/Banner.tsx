  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[56rem] mx-auto px-4 sm:px-6 lg:px-8 pt-16 flex flex-col items-center">
        <h2 className="text-white text-3xl sm:text-4xl lg:text-4xl font-semibold">
          Elevating Experiences through Exceptional Services and Innovative
          Solutions
        </h2>
        <p className="mt-5 text-white text-md max-w-2xl text-center">
